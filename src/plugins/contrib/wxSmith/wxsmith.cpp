...
*
* $Revision: 4 $
* $Id: wxsmith.cpp 4 2013-11-02 15:53:52Z gerard $
* $HeadURL: svn://svn.berlios.de/codeblocks/trunk/src/plugins/contrib/wxSmith/wxsmith.cpp $
*/
...
bool wxSmith::BuildToolBar(wxAuiToolBar* toolBar)
{
	return false;
}
