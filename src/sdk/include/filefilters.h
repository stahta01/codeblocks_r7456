...
#define EM_WORKSPACE_OPEN_FILTER_TXT _T("Em::Blocks workspace files")
#define EM_PROJECT_OPEN_FILTER_TXT   _T("Em::Blocks project files")
//#define EM_STANDARD_OPEN_FILTER_TXT  _T("Em::Blocks project/workspace files")
#define EM_STANDARD_OPEN_FILTER_TXT  _T("Em::Blocks project files")

/** Provides functions and constants regarding
  * file extension filters present in file dialogs
  * throughout Em::Blocks.
  */
namespace FileFilters
{
    ...
    /** @brief Removes the filter 'FilterName' from the FiltersList
      * @param FilterName Name of the filter we want to know the index of
      * @return none
      */
    DLLIMPORT void FilterNameRemove(const wxString& FilterName);

    // file extension constants
    // *just* the extension, e.g. "exe"
    extern const DLLIMPORT wxString WORKSPACE_EXT;
    extern const DLLIMPORT wxString EMBLOCKS_EXT;
    ...
    extern const DLLIMPORT wxString MAP_EXT;
    extern const DLLIMPORT wxString HEX_EXT;
    extern const DLLIMPORT wxString LIBRARY_EXT;
    ...
    extern const DLLIMPORT wxString MPLAB8PRJ_EXT;
    extern const DLLIMPORT wxString ELAY_EXT;           // The em::blocks layout file extension

    // a dot *and* the extension, e.g. ".exe"
    extern const DLLIMPORT wxString WORKSPACE_DOT_EXT;
    extern const DLLIMPORT wxString EMBLOCKS_DOT_EXT;;
    ...
    extern const DLLIMPORT wxString MAP_DOT_EXT;
    extern const DLLIMPORT wxString LIBRARY_DOT_EXT;
    ...
    extern const DLLIMPORT wxString MPLAB8PRJ_DOT_EXT;
    extern const DLLIMPORT wxString ELAY_DOT_EXT;
};
